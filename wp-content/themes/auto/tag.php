...
<section>
    <div class="container sm:px-4 mx-auto">
        <div class="flex md:flex-col md:items-center md:text-center">
                ...
                <div class="grid grid-cols-2 gap-[30px] md:grid-cols-1">
                    ...
                    if ($tag_query->have_posts()) {
                        while ($tag_query->have_posts()) {
                            $tag_query->the_post();
                            ?>
                            <div class="flex flex-col rounded-[12px] bg-[white] mb-[56px] sm:mb-[0px]  md:h-[auto] md:w-[auto] md:items-center">
                                <div class="sm:mb-[24px]">
                                    <?php
                                        if (has_post_thumbnail()) {
                                        the_post_thumbnail('large', array('class' => 'object-cover h-[262px] w-[413px] rounded-[12px] md:h-[auto] md:w-[auto]'));
                                             }
                                    ?>
                                </div>
                                <div
                                    ...
                                    ?>
                                    <h3
                                        class="line-clamp-2 text-[27px] text-textTitles font-semibold leading-[140%] mb-[23px] mt-[8px] sm:text-center sm:w-[auto] hover:text-primary">
                                        <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    </h3>
                                    <div
                                        class="flex gap-[8px] items-center sm:w-[auto] sm:flex-wrap md:justify-center sm:mb-[24px]">
