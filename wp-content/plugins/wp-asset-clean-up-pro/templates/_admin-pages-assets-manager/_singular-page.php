...
<form id="wpacu_dash_assets_manager_form" method="post" action="<?php echo esc_url(admin_url($strAdminUrl)); ?>">
    ...
    <div class="wpacu_verified">
        ...
        | <strong><?php echo isset($postName) ? esc_html($postName) : ''; ?> Заголовок:</strong> <?php echo get_the_title($data['post_id']); ?> | <strong>Post ID:</strong> <?php echo (int)$data['post_id']; ?>
    </div>
    ...
    ?>
        <div id="wpacu_meta_box_content">
            ...
            if ($data['wpacu_settings']['dom_get_type'] === 'direct') {
                ?>
                <div id="wpacu-list-step-default-status" style="display: none;"><img src="<?php echo esc_url(admin_url('images/spinner.gif')); ?>" align="top" width="20" height="20" alt="" />&nbsp; Пожалуйста, подождите...</div>
                <div id="wpacu-list-step-completed-status" style="display: none;"><span style="color: green;" class="dashicons dashicons-yes-alt"></span> Завершенный</div>
                <div>
                    <ul class="wpacu_meta_box_content_fetch_steps">
                        <li id="wpacu-fetch-list-step-1-wrap"><strong>Шаг 1</strong>: Получить ресурсы с целевой страницы... <span id="wpacu-fetch-list-step-1-status"><img src="<?php echo esc_url(admin_url('images/spinner.gif')); ?>" align="top" width="20" height="20" alt="" />&nbsp; пожалуйста, подождите...</span></li>
                        <li id="wpacu-fetch-list-step-2-wrap"><strong>Шаг 2</strong>: Создайте список извлеченных ресурсов и распечатайте его.... <span id="wpacu-fetch-list-step-2-status"></span></li>
                    </ul>
                </div>
                <?php
            } else {
