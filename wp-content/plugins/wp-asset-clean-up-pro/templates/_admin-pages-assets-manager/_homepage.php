        ...
        if ($wpacuNoLoadInTargetPage = in_array($wpacuNoLoadMatchesStatus, array('is_set_in_settings', 'is_set_in_page'))) {
	        if ($wpacuNoLoadMatchesStatus === 'is_set_in_settings') { // Asset CleanUp Pro is set not to load for the front-page
                ...
                <p class="wpacu_verified">
                    <strong>Целевой URL:</strong> <a target="_blank" href="<?php echo esc_url($data['site_url']); ?>"><span><?php echo esc_url($data['site_url']); ?></span></a>
                </p>
                ...
                ?>
                    ...
                    <div>
                        <ul class="wpacu_meta_box_content_fetch_steps">
                            <li id="wpacu-fetch-list-step-1-wrap"><strong>Шаг 1</strong>: Получить активы с главной страницы... <span id="wpacu-fetch-list-step-1-status"><img src="<?php echo esc_url(admin_url('images/spinner.gif')); ?>" align="top" width="20" height="20" alt="" />&nbsp; пожалуйста, подождите...</li>
