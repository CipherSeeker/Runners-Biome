...
<div style="margin: 25px 0 0;">
    ...
    ?>
        <p>Тип сообщения: «страница» (например, такие страницы, как «О нас», «Контакты» и т. д.) &#10230; <a target="_blank" href="https://wordpress.org/support/article/pages-screen/"><?php _e('read more', 'wp-asset-clean-up'); ?></a></p>
    <?php
