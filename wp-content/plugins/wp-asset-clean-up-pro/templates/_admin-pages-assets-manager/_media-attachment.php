...
?>
<p>Тип сообщения: «вложение» (например, файлы из <a target="_blank" href="https://wordpress.org/support/article/media-library-screen/">"Media" &#187; "Library"</a>, загруженная страница обычно печатает изображение или другой тип носителя) &#10230; <a target="_blank" href="https://wordpress.org/support/article/edit-media/"><?php _e('read more', 'wp-asset-clean-up'); ?></a></p>
<?php
