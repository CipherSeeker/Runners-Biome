...
<div style="margin: 25px 0 0;">
	...
	?>
    <p>Популярные примеры: «продукт», созданный WooCommerce, «загрузка», созданная Easy Digital Downloads и т. д. &#10230; <a target="_blank" href="https://wordpress.org/support/article/post-types/#custom-post-types"><?php _e('read more', 'wp-asset-clean-up'); ?></a></p>
    <?php
