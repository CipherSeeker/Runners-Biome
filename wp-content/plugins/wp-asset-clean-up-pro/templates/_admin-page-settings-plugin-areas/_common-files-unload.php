    ...
    <table class="wpacu-form-table">
        <tr valign="top">
            ...
            <td>
                ...
                <?php echo sprintf(esc_html__('This will unload %s', 'wp-asset-clean-up'), 'WordPress\' Emojis'); ?> (значки смайликов)
        ...
        <tr valign="top">
            <th scope="row" class="setting_title">
                ...
                <p style="margin-top: 2px;" class="wpacu_subtitle"><small><a target="_blank" href="https://wordpress.org/support/article/embeds/">Подробнее о встраиваниях</a></small></p>
            </th>
            <td>
                <label class="wpacu_switch">
                ...
                <div style="margin-top: 10px;">
                    ...
                    <ul>
                        <li>- Вы хотите, чтобы другие пользователи вставляли ваши статьи блога WordPress на свой сайт.</li>
                        <li>- Вы хотели бы вставлять статьи других веб-сайтов, видео YouTube, твиты и т. д. в свои статьи блога WordPress.</li>
                    </ul>
        ...
        <tr valign="top">
            <th scope="row">
                ...
                <p style="margin-top: 2px;" class="wpacu_subtitle"><small>Верхняя панель администратора (панель инструментов) требует, чтобы Dashicons функционировали должным образом..<br /><a target="_blank" href="https://developer.wordpress.org/resource/dashicons/">Читать о дашиконах</a> | <a target="_blank" href="https://wordpress.org/support/article/toolbar/">Читать о Панели инструментов</a></small></p>
            </th>
            <td>
                <label class="wpacu_switch">
        ...
        <tr valign="top">
            <th scope="row" style="opacity: <?php echo esc_attr($jqueryMigrateUnloadOpacity); ?>;">
                <label for="wpacu_disable_jquery_migrate"><?php echo sprintf(__('Disable %s Site-Wide', 'wp-asset-clean-up'), 'jQuery Migrate'); ?> <span style="color: #cc0000;" class="dashicons dashicons-wordpress-alt wordpress-core-file"><span class="wpacu-tooltip">WordPress Core File<br />Не уверен, нужен он или нет? В этом случае лучше оставить его загруженным, чтобы не сломать сайт.</span></span></label>
            </th>
            <td>
                <?php if ($isjQueryMigrateUnloaded) { ?>
                    <div style="margin-bottom: 10px;" class="wpacu-warning">
                        <p style="margin-top: 0;"><span style="color: darkorange;" class="dashicons dashicons-warning"></span> Начиная с WordPress 5.5, jQuery Migrate больше не загружается, поэтому этот параметр больше не актуален для вашего веб-сайта (который использует WordPress <?php echo esc_html($wp_version); ?>), поскольку он всегда включен. Если вам нужно загрузить jQuery Migrate, как это было раньше, проверьте <strong><a rel="noopener noreferrer" target="_blank" href="https://wordpress.org/plugins/enable-jquery-migrate -helper/">Включить плагин jQuery Migrate Helper</a></strong></p>
                    </div>
                <?php } ?>
