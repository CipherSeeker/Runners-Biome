...
<form id="wpacu-frontend-form" action="#wpacu_wrap_assets" method="post">
    <div id="wpacu_wrap_assets">
        ...
        if ($data['is_wp_recognizable']) {
            ...
            ?></small></p>
        <?php } else { ?>
            <p>Эта страница не является узнаваемой WordPress. Если вы считаете, что должны увидеть здесь список ресурсов (CSS и JavaScript), пожалуйста, <a href="https://www.gabelivan.com/contact/">свяжитесь со мной</a>.</p>
        <?php
        }
        ?>
    </div>
