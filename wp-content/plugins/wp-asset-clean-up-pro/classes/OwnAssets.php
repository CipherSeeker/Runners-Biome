...
class OwnAssets
{
	...
	public function init()
    {
	    ...
	    add_filter('wpacu_object_data', static function($wpacu_object_data) {
		    ...
		    // [wpacu_pro]
		    $wpacu_object_data['wpacu_update_plugin_row_state_nonce'] = wp_create_nonce('wpacu_update_plugin_row_state_nonce');
		    $wpacu_object_data['wpacu_area_update_plugins_row_state_nonce'] = wp_create_nonce('wpacu_area_update_plugins_row_state_nonce');
    ...
    public function stylesAndScriptsForAdmin()
    {
        ...
        // [wpacu_pro]
        $ownAssetsPro = new \WpAssetCleanUpPro\OwnAssetsPro();
	    if ($ownAssetsPro->isTaxonomyEditPage()) {
		    $this->loadPluginAssets = true;
        }
        // [/wpacu_pro]
...
HTML;
		...
		if ( $page === WPACU_PLUGIN_ID . '_settings' || $isDashManageAssetsPage || $isEditPostArea /*[wpacu_pro]*/|| $isPluginsManagerAreaFront/*[/wpacu_pro]*/) {
		    $this->loadjQueryChosen();
        }
