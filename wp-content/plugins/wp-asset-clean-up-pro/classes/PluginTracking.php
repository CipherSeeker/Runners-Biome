		...
		<div class="wpacu-tracking-notice notice is-dismissible">
			...
			<div class="wpacu-action-links">
				<ul>
			        ...
			        <li class="wpacu-more-info"><span style="color: #004567;" class="dashicons dashicons-info"></span> <a id="wpacu-show-tracked-data" href="#">Какие данные будут отправлены для отслеживания?</a></li>
				</ul>
                ...
                <hr />
                <p><strong>Примечание.</strong> Этот параметр всегда можно включить или отключить в <a style="text-decoration: none;" target="_blank" href="<?php echo admin_url('admin.php?page=wpassetcleanup_settings&wpacu_selected_tab_area=wpacu-setting-plugin-usage-settings#wpacu-settings-allow-usage-tracking'); ?>">«Настройки» → «Настройки использования плагинов» → «Разрешить отслеживание использования»</a></p>
			</div>
		</div>
		<?php
	...
	public static function showSentInfoDataTable($data)
    {
        ...
        <div class="wpacu_table_wrap">
            <table class="table table-striped">
                <tr>
                    <td style="width: 182px;">PHP Версия:</td>
                    <td><?php echo esc_html($data['php_version']); ?></td>
                </tr>
                <tr>
                    <td>Asset CleanUp Info:</td>
                    <td>Version: <?php echo esc_html($data['wpacu_version']); ?>, Настройки и информация об использовании</td>
                </tr>
                <tr>
                    <td>WordPress Версия:</td>
                ...
                <tr>
                    <td>Плагины:</td>
                    <td>Список активных и неактивных плагинов</td>
                </tr>
            </table>
        </div>
        <?php
