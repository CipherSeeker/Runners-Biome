...
update_option( 'wpassetcleanup_pro_license_key', 'license-key----------license-key' );
update_option( 'wpassetcleanup_pro_license_status', 'valid' );

define('WPACU_PRO_PLUGIN_VERSION', '1.2.3.7.1');
...
if (WPACU_GET_LOADED_ASSETS_ACTION === true ||
	...
	if ( PHP_VERSION_ID >= 70100 ) {
		// PHP version 7.1+
		require_once WPACU_PLUGIN_DIR . '/vendor-extra/t-regx/vendor/autoload.php';
	} else {
		// PHP version 5.6+ up to 7
		require_once WPACU_PLUGIN_DIR . '/vendor-extra/t-regx-fallback/vendor/autoload.php';
	}
	// [/wpacu_pro]
}
